...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-50 bg-white dark:bg-gym-black border-b border-gray-200 dark:border-gym-gray px-6 py-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        {/* Desktop Links */}
        <ul className="hidden md:flex space-x-8 text-gray-600 dark:text-gray-300 font-bold uppercase text-xs tracking-widest">
